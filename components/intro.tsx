  ...
  return (
    ...
    >
        ...
        <div className="relative">
          ...
          >
            <Image
              ...
              quality="95"
              priority={true}
              className="h-[11rem] w-[11rem] rounded-full object-cover border-[0.35rem] border-gray shadow-xl"
            />
          </motion.div>
          <motion.span
      ...
      >
        ...
        <span className="font-bold">Full-Stack & Front-End Developer</span> with{" "}
        <span>passion and expertise</span>. I thrive on creating{" "}
      ...
      >
        ...
        <a
          href="https://www.linkedin.com/in/evoxf1/"
          target="_blank"
